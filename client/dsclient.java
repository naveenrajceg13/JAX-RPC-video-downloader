...
public class dsclient extends Frame implements ActionListener
{
    ...
    dsclient()
   {
              ...
              stub._setProperty(javax.xml.rpc.Stub.ENDPOINT_ADDRESS_PROPERTY,"http://192.168.0.22:8080/ds/DistributedService?WSDL");
             dsi=(Dsint)stub;
              f=new Frame("welcome");
                 ...
                 if(action.equals("download"))
                    {
                                       ...
                                       f1.add(down);
                                       f1.add(new Label("enter the name to be stored in ur meachine "));
                                       f1.add(store);
                                       f1.add(downlod);
                                       f1.add(exit);
